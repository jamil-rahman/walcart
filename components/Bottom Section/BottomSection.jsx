    ...
    <div style={{ paddingTop: "3rem", backgroundColor: "#F5F5F5" }}>
      <Container>
        ...
        <div style={{ paddingTop: "30px" }}>
          <Row>
            <Col md={3}>
              <Category src={laptop} alt="laptop" title="Electronic Appliances" />
            </Col>

            <Col md={3}>
              <Category src={basket} alt="basket" title="Electronic Appliances" />
            </Col>

            <Col md={3}>
              <Category src={popcorn} alt="popcorn" title="Electronic Appliances" />
            </Col>

            <Col md={3}>
              <Category src={profile_1} alt="profile_1" title="Electronic Appliances" />
            </Col>
          </Row>

          <Row>
            <Col md={3}>
              <Category src={profile_2} alt="profile_2" title="Electronic Appliances" />
            </Col>
            ...
            <Col md={3}>
              <Category  src={electronics} alt="electronics" title="Electronic Appliances"/>
            </Col>
